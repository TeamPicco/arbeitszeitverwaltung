...
def apply_custom_css():
    ...
    /* ===== SELECTBOX SICHTBARKEIT - MAXIMALE PRIORITÄT ===== */
    ...
    /* BaseWeb Select - Value Container (KRITISCH) */
    div[data-baseweb="select"] > div[role="button"] > div:first-child,
    div[data-baseweb="select"] > div[role="button"] > div[data-baseweb="input"],
    div[data-baseweb="select"] div[class*="ValueContainer"] {{
        color: #212529 !important;
        background-color: transparent !important;
    }}
    
    /* BaseWeb Select - Alle Textelemente */
    ...
    /* BaseWeb Select - Input Element */
    div[data-baseweb="select"] input {{
        color: #212529 !important;
        background-color: transparent !important;
    }}
    
    /* BaseWeb Select - Dropdown Icon */
    div[data-baseweb="select"] svg {{
        fill: #495057 !important;
        color: #495057 !important;
    }}
    
    /* BaseWeb Select - Hover State */
    div[data-baseweb="select"]:hover {{
        border-color: #80bdff !important;
    }}
    
    /* BaseWeb Select - Focus State */
